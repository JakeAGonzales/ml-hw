...
class LinearLayer(nn.Module):
    ...
    def __init__(
        ...
        Note:
            ...
            - Make use of pytorch documentation
        """
        super().__init__()
        self.weights = nn.Parameter(torch.randn(dim_in, dim_out, generator = generator))
        self.bias = nn.Parameter(torch.randn(dim_out, generator = generator))
